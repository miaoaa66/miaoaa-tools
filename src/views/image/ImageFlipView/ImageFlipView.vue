        ...
        <div class="preview-area">
          ...
          <div class="preview-container">
            <div class="image-wrapper">
              <img :src="imageUrl" :style="previewStyle" />
            </div>
          </div>
        </div>
        ...
        <div class="controls">
          <el-form label-width="84px" size="default">
            <el-form-item label="水平翻转">
              <el-switch v-model="flipH" active-text="开启" inactive-text="关闭" />
            </el-form-item>

            <el-form-item label="垂直翻转">
              <el-switch v-model="flipV" active-text="开启" inactive-text="关闭" />
            </el-form-item>
...
async function download() {
  ...
  try {
    ...
    // 先平移再缩放，实现沿中心轴的镜像翻转
    ctx.translate(flipH.value ? outW : 0, flipV.value ? outH : 0)
    ...
    const suffix = `${flipH.value ? 'h' : ''}${flipV.value ? 'v' : ''}`
    a.download = `${baseName}_flip${suffix}.png`
    a.click()
